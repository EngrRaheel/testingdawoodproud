...
function ServiceCards() {
    return (
        <div className="flex flex-col  md:space-y-14 bg-cover bg-center bg-[url('/Images/blob_bg_2.png')] ">
            ...
            <ServiceCard heading={"Overall YouTube Channel Management"}
                ...
                btntext={"Let us Help you Grow"} bgColor={"bg-cover bg-center bg-[url('/Images/calltoaction.webp')]"} link={"/consultation"} images={"/Images/Services/Overall YouTube Channel Management.png"} />
