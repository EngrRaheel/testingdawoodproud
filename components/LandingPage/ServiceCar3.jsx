...
function ServiceCard2({ heading, heading2, para, btntext, bgColor, link, images, icon, text, bg }) {
    return (
        <div className={`w-full min-h-[100vh] font-Inter text-[black] relative ${bgColor}`}>
            <div className='flex flex-col md:flex-row justify-center md:justify-center md:items-center max-w-[1024px] mx-auto ' >
                ...
                <div className='w-full flex-1 '>
                    <div className='flex flex-col justify-center items-center md:items-start gap-4'>
                        <div className='flex flex-col justify-start items-start gap-6'>
                            ...
                            <h3 className="font-extrabold text-[24px] md:text-[36px] lg:text-[40px] text-center md:text-left leading-[43px] max-w-sm">{heading2}</h3>
                        </div>
