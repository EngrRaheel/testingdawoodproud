...
function SuperchargeYT() {
    return (
        <div className=' w-full min-h-full'>
            <div className="w-full  font-Inter h-[500px] ">
                <div className=' w-full h-full   hsds-row--oval-bottom bg-[#294dff]'>
                    <div className="w-full  max-w-[1172px] m-auto flex flex-col  gap-14 md:gap-10 lg:gap-12 justify-center items-center z-20 relative mt-32 ">
