...
function SuperchargeYT() {
    return (
        <div className="w-full min-h-screen flex justify-center items-center font-Inter   bg-cover bg-center bg-[url('/Images/calltoaction.webp')] bg-[#001b47] ">
            <div className="w-full  max-w-[1172px] m-auto flex flex-col  gap-14 md:gap-10 lg:gap-12 justify-center items-center ">
                ...
                <button className='flex justify-center items-center px-5 py-3 rounded-full bg-[#0077cc] hover:bg-[#3b82f6] text-white font-bold gap-2'>
