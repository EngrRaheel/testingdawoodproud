...
const SignupForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col items-center max-w-[100%] xl:max-w-[100%] space-y-1 sm:space-y-2 mt-8 xl:mt-20 font-Factor_A">
            <button
            ...
            >
                <div className='flex justify-center items-center gap-3 h-[50px]'>
                    ...
                    <p className=' text-[12px] sm:text-base font-medium font-Inter'>Sign Up with Your Google account</p>
                </div>
