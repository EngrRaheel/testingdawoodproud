...
const SignupForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col items-center max-w-[90%] lg:max-w-[70%] space-y-2">
            <button
            ...
            >
                <div className='flex justify-center items-center gap-3'>
                    ...
                    <p className='font-inter text-sm sm:text-base'>Sign Up with Your Google account</p>
                </div>
