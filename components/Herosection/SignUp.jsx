...
const SignupForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col items-center max-w-[70%] space-y-2">

            <button
                onClick={handleGoogleSignup}
                className="p-2 rounded-full border-2 border-[#3b82f6]/90 bg-blue/10 hover:bg-white hover:text-blue text-white font-normal cursor-pointer mb-4 w-full h-[50px]"
            >
            ...
            <button
                type="submit"
                className="p-2 !rounded-full border-2 border-[#3b82f6]/90 bg-blue-500 text-white font-bold cursor-pointer w-full h-[50px]"
            >
                Sign Up
            </button>
        </form>
